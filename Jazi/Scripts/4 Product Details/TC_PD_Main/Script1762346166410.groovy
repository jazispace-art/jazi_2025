...
if (Mobile.waitForElementPresent(findTestObject(btn4), 10, FailureHandling.STOP_ON_FAILURE)) {
	...
	KeywordUtil.markPassed('--------------------Test Case Completed--------------------')
	...
	KeywordUtil.markFailed('--------------------Test Case Not Completed--------------------')
}
...
//	null,FailureHandling.STOP_ON_FAILURE)
//
//Mobile.callTestCase(findTestCase('Test Cases/4 Product Details/Add Ons/Select Product Size'),
//	null,FailureHandling.STOP_ON_FAILURE)
//
